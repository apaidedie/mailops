...
3. Implement mailbox_directory projection in mailops.services.provider_catalog.get_external_api_readiness_summary, reusing mailops.services.mailbox_catalog.list_unified_mailboxes inside the function body to avoid module import cycles.
