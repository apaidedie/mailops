"""mailops/services/telegram_push.py — Telegram 实时推送核心服务
...
from mailops.services.providers import (
...
def _fetch_new_emails_graph(account: dict, since: str, folder: str = "inbox") -> List[dict]:
    ...
    from mailops.security.crypto import decrypt_data
    from mailops.services.graph import build_proxies, get_access_token_graph
...
def run_telegram_push_job(app) -> None:
    ...
    with app.app_context():
        from mailops.db import get_db
        from mailops.repositories.accounts import (
