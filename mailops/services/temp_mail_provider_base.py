...
from mailops.temp_mail_registry import _REGISTRY, get_registry_snapshot
...
def _ensure_builtin_providers_loaded() -> None:
    ...
    try:
        import mailops.services.temp_mail_provider_cf  # noqa: F401
        import mailops.services.temp_mail_provider_custom  # noqa: F401
        import mailops.services.temp_mail_provider_public  # noqa: F401
    except Exception:
