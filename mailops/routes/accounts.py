...
from mailops.controllers import accounts as accounts_controller
...
def create_blueprint() -> Blueprint:
    ...
    bp.add_url_rule(
        ...
        view_func=accounts_controller.api_get_provider_preflight,
        methods=["GET"],
    )
    bp.add_url_rule(
        "/api/providers/<kind>/<provider>/health",
        view_func=accounts_controller.api_get_provider_health,
        methods=["GET"],
    )
    bp.add_url_rule(
