...
from mailops.controllers import emails as emails_controller
...
def create_blueprint() -> Blueprint:
    ...
    add_external_api_url_rule(
        bp,
        "/api/v1/external/messages/<path:message_id>",
        view_func=emails_controller.api_external_get_message_detail,
        methods=["GET"],
    )
    add_external_api_url_rule(
        bp,
        "/api/v1/external/messages/<path:message_id>/raw",
