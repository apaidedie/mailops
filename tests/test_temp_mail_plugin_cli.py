...
class TestPluginCLI(unittest.TestCase):
    ...
    # G-CLI-01
    @patch("mailops.services.temp_mail_plugin_cli.install_plugin")
    @patch("mailops.services.temp_mail_plugin_cli._confirm", return_value=True)
    ...
    def test_cli_install_plugin(self, mock_print, mock_confirm, mock_install):
        ...
        from mailops.services.temp_mail_plugin_cli import _cmd_install
    ...
    # G-CLI-03
    @patch("mailops.services.temp_mail_plugin_cli.uninstall_plugin")
    @patch("mailops.services.temp_mail_plugin_cli._confirm", return_value=True)
    @patch("mailops.services.temp_mail_plugin_cli.check_provider_in_use", return_value={"task_count": 0, "active_count": 0})
    @patch("builtins.print")
    def test_cli_uninstall_plugin(self, mock_print, mock_check, mock_confirm, mock_uninstall):
        ...
        from mailops.services.temp_mail_plugin_cli import _cmd_uninstall

        _cmd_uninstall("moemail")
        mock_uninstall.assert_called_once()

    # G-CLI-04
    @patch("mailops.services.temp_mail_plugin_cli.get_available_providers")
    @patch("mailops.services.temp_mail_plugin_cli.get_installed_plugins")
    @patch("builtins.print")
    ...
    def test_scaffold_provider_writes_valid_contract_plugin(self):
        from mailops.services.temp_mail_plugin_manager import scaffold_provider_plugin
        from mailops.services.temp_mail_provider_base import _REGISTRY, TempMailProviderBase
    ...
    @patch("mailops.services.temp_mail_plugin_cli.scaffold_provider_plugin")
    @patch("builtins.print")
    def test_cli_scaffold_provider(self, mock_print, mock_scaffold):
        ...
        from mailops.services.temp_mail_plugin_cli import _cmd_scaffold
    ...
    def test_cli_validate_provider_file_outputs_valid_json(self, mock_print):
        from mailops.services.temp_mail_plugin_cli import _cmd_validate_provider
