// split from external_api_ui.js → commands.js
        ...
        function renderExternalApiCommandCenter(settings = {}, state = 'ready') {
            ...
            // First screen: head → onboarding → KPI → compact checks → endpoints.
            // Advanced tools stay available but collapsed for screenshot / scan density.
            root.innerHTML = [
                ...
                '<div class="external-api-command-metrics">',
                    ...
                    renderExternalApiCommandMetric('调用方密钥', String(multiKeyCount), multiKeyCount > 0 ? translateAppTextLocal('已配置') : translateAppTextLocal('未配置')),
                    ...
                    renderExternalApiCommandMetric('邮箱池服务', poolStatus.value, poolStatus.detail),
                ...
                '<div class="external-api-command-body">',
                    ...
                    '</div>',
                '</div>',
                '<details class="external-api-advanced-tools">',
                    `<summary class="external-api-advanced-tools-summary">${escapeHtml(translateAppTextLocal('高级工具'))}<span class="external-api-advanced-tools-meta">${escapeHtml(translateAppTextLocal('Bundle · Handoff · Playbooks'))}</span></summary>`,
                    '<div class="external-api-advanced-tools-body">',
