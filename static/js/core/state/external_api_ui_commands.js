// split from external_api_ui.js → commands.js
        ...
        function renderExternalApiCommandCenter(settings = {}, state = 'ready') {
            ...
            // First screen: head + KPI only. Diagnostics/smoke/playbooks stay collapsed.
            root.innerHTML = [
                ...
                '<details class="external-api-advanced-tools">',
                    `<summary class="external-api-advanced-tools-summary">${escapeHtml(translateAppTextLocal('高级工具'))}<span class="external-api-advanced-tools-meta">${escapeHtml(translateAppTextLocal('Smoke · Bundle · Playbooks'))}</span></summary>`,
