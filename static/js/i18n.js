(function () {
    ...
    const exactMap = {
        ...
        '邮箱聚合指挥台': 'Mailbox command center',
        ...
        '第': 'Page',
        '总账号数': 'Total Accounts',
        '统一邮箱指挥台': 'Unified mailbox command center',
        '聚合邮箱、Provider 与外部 API 接入状态': 'Mailbox, provider, and external API readiness',
        '一眼看清邮箱库存、服务就绪与外部接入': 'See mailbox inventory, service readiness, and external access at a glance',
        '总体状态': 'Overall status',
        ...
        '外部接入指挥台': 'External access command center',
        '统一暴露邮箱目录、Provider 路由、OpenAPI 与验证码读取入口': 'Expose mailbox directory, provider routing, OpenAPI, and verification-code access in one place',
        '管理外部调用入口：邮箱目录、服务路由、接口文档与验证码读取': 'Manage external access: mailbox directory, service routing, API docs, and verification-code reads',
        '调用方密钥': 'Caller keys',
